<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h3>2.3.6                Sintaxis para la correcta aplicación de reglas de negocio y reglas de validación</h3>
...
<li>Variables de Sesión: las variables de sesión son variables especiales de Simple, que completan la información de acuerdo al usuario que se encuentra registrado (logeado) realizando la etapa del trámite, siendo:
<ul>
<li>Formato general: @!variable_de_sesion</li>
<li>Palabras claves admitidas en Simple: @!rut, @!nombres, @!apellido_paterno, @apellido_materno, @!email, @!tramite_id(este último otorga el ID de trámite que se está cursando).</li>
</ul>
<p>Variables Globales del trámite: estas variables obtienen el conjunto de toda la información que una variable tenga en TODOS los procesos/trámites generados, la forma de identificarlo es con un @#variable, un ejemplo ùtil del uso de esta variable es permitir identificar si una solicitud de trámite ya ha sido solicitada, o si un ciudadano ya solicitó un trámite en particular, esto se realizaría leyendo la variable  @#ciudadano y luego buscando dentro del arreglo que entrega in_array(@#ciudadano) con esto último se validará si el ciudadano está en el arreglo.</p>
</li>
</ul>
</li>
</ul>
...
<p> </p>
<p>Existen además reglas de validación automática, las cuales deben ser separadas mediante el símbolo | (tubo) en el campo a validar, el listado es el siguiente:</p>
...
<td valign="bottom" width="307">
<p>Valida campo Rut con su lógica.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Señala que el campo debe ser requerido. Retorna Falso si el campo está vacío.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Compara el campo actual con un campo del formulario que debe ser pasado por parámetro. Si son negativos retorna Falso.</p>
</td>
<td valign="bottom" width="169">
<p>matches[form_item]</p>
</td>
</tr>
<tr>
<td valign="bottom" width="163">
...
<td valign="bottom" width="307">
<p>Retorna Falso si el largo del campo es menor a lo indicado por parámetro.</p>
</td>
<td valign="bottom" width="169">
<p>min_length[6]</p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el largo del campo es mayor a lo indicado por parámetro.</p>
</td>
<td valign="bottom" width="169">
<p>max_length[12]</p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el largo del campo no es exacto  al valor indicado por parámetro.</p>
</td>
<td valign="bottom" width="169">
<p>exact_length[8]</p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el largo del campo es menor al indicado por parámetro.</p>
</td>
<td valign="bottom" width="169">
<p>greater_than[8]</p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el largo del campo es mayor al indicado por parámetro.</p>
</td>
<td valign="bottom" width="169">
<p>less_than[8]</p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el campo contiene cualquier carácter distinto al abecedario.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el campo contiene cualquier carácter distinto a alfanumérico.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el campo contiene cualquier carácter distinto a alfanumérico, caracteres numéricos, barras.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el campo no es numérico.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el campo no es un valor entero.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el campo no es un número natural.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el campo no es un número natural excluyendo el cero.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si el campo no es un correo electrónico válido.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<td valign="bottom" width="307">
<p>Retorna Falso si los correos electrónicos indicados en el campo no son correos electrónicos válidos.</p>
</td>
<td valign="bottom" width="169">
<p> </p>
</td>
...
<p> </p>
<p> </p>
<p>Ejemplos de validación de campos:</p>
<ol>
...
<p><img src="assets/img/BackEnd/Reglas-Validacion-Negocio/Figura-47.png" alt="" width="454" height="288" /></p>
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Reglas de Negocio y Reglas de Validación</title>
    <!-- Bootstrap -->
...
<li class="last active current"><a href="simple/backend/modelamiento-del-proceso/reglas-de-negocio-y-reglas-de-validacion.html" title="Reglas de Negocio y Reglas de Validación" >Reglas de Negocio y Reglas de Validación</a></li>
</ul></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li><a href="simple/backend/modelamiento-del-proceso/">Modelamiento del Proceso</a> <span class="divider">/</span></li><li>Reglas de Negocio y Reglas de Validación</li>
</ul>
