<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h3>3.1.2      Perfil de Usuarios Registrados: Ciudadanos y Usuarios Comunes - Ventana Principal</h3>
<p> </p>
<p>Como se ha comentado en la sección anterior, existen reclamos para los cuales se requiere cierta información especial, privada o el trámite por normativa no es posible acceder de manera generalizada al Portal de Simple, para esto es necesario que el Ciudadano / Usuario inicie sesión en el Portal de Simple, actualmente existen dos formas para el ingreso al Portal Simple: registrándose directamente en el Portal de Simple, o si posee ClaveÚnica acceder directamente con ella, siendo este último método la forma de validar realmente que quien realice el trámite sea realmente quien dice ser. En el recuadro en rojo de la imagen siguiente se indica la sección en donde se podrá registrar y/o acceder al portal:</p>
<p> </p>
<p style="text-align: center;">  <img src="assets/img/FrontEnd/frontendf3.png" alt="" width="454" height="141" /></p>
<p style="text-align: center;">Figura 56: "FrontEnd Simple - Ingreso Usuario"</p>
<p style="text-align: center;"> </p>
<p>Una vez que haya ingresado, se desplegará la Ventana Principal del FrontEnd de Simple para usuario registrado, en donde se despegarán la totalidad de trámites realizables por el Ciudadano / Usuario de Simple.</p>
<p> </p>
<p style="text-align: center;">  <img src="assets/img/FrontEnd/frontendf4.png" alt="" width="454" height="213" /></p>
<p style="text-align: center;">Figura 57: "Portal Simple FrontEnd – Ciudadanos / Usuarios Registrados"</p>
<p> </p>
<p> </p>
<p>Se destacan las siguientes opciones:</p>
<p>Enlace <em>Iniciar Trámite <img src="assets/img/FrontEnd/frontendf5.png" alt="" width="113" height="13" /></em>: corresponde a la opción predeterminada que se abrirá al ingresar al portal, esta opción lista todos los trámites disponibles, tanto para trámites públicos, trámites sólo para usuarios registrados, para proceder a iniciar un nuevo trámite simplemente seleccione el botón <img src="assets/img/FrontEnd/frontendf2.png" alt="" width="45" height="16" /> , dentro de la fila del trámite que desea iniciar.</p>
<p> </p>
<p style="text-align: center;"> <img src="assets/img/FrontEnd/frontendf6.png" alt="" width="454" height="213" /></p>
<p style="text-align: center;">Figura 58: "FrontEnd Simple: Listado de Trámites disponibles a iniciar"</p>
<p style="text-align: center;"> </p>
<p style="text-align: center;"> </p>
<p>Enlace <em>Bandeja de Entrada</em> : con esta opción el usuario registrado podrá revisar el estado de los trámites que ha realizado mediante el sistema Simple.</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf7.png" alt="" width="454" height="131" /> </p>
<p style="text-align: center;">Figura 59: "FrontEnd Simple: Bandeja de Entrada"</p>
<p style="text-align: center;"> </p>
<p style="text-align: center;"> </p>
<p>Para revisar la última acción sobre un trámite pendiente de realización, deberá hacer clic sobre el botón <em>Realizar</em>.</p>
<p>Para eliminar un trámite que haya iniciado y desea eliminar, desde la bandeja de entrada es posible de realizar, sí y sólo sí si en la gestión del trámite no habido participación de otros usuarios, esto lo podrá identificar porque bajo el trámite aparecerá el icono <img src="assets/img/FrontEnd/frontendf9.png" alt="" width="39" height="23" />, en el que al realizar clic se podrá eliminar el trámite del sistema, considere que las eliminaciones no son reversibles.</p>
<p style="text-align: center;"> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf10.png" alt="" width="557" height="182" /></p>
<p style="text-align: center;">Figura 60: "Realizar/Rechazar desde Bandeja de Entrada"</p>
<p> </p>
<p> </p>
<p>Enlace <em>Sin Asignar</em>  <img src="assets/img/FrontEnd/frontendf11.png" alt="" width="121" height="13" />: con esta opción podrá revisar los trámites generados los cuales no tengan usuario ni grupo para su gestión (revisión). Las opciones de la ventana Sin Asignar se visualizan en la imagen siguiente.</p>
<p> </p>
<p style="text-align: center;"> <img src="assets/img/FrontEnd/frontendf12.png" alt="" width="520" height="156" /></p>
<p style="text-align: center;">Figura 61: "FrontEnd Simple: Etapas Sin Asignar"</p>
<p> </p>
<p>Enlace <em>Participados <img src="assets/img/FrontEnd/frontendf13.png" alt="" width="138" height="18" /> </em>: con esta opción usted podrá ver el listado de todos los trámites que ha participado, en donde se le indicará su ID, el nombre del trámite que ha realizado, la etapa actual en que se encuentra el trámite, la última fecha que ha sido modificado dentro del proceso, el estado del trámite y el historial de tareas que ha ejecutado en el trámite. Tal como se puede visualizar en la imagen siguiente.</p>
<p> </p>
<p style="text-align: center;"> <img src="assets/img/FrontEnd/participados2.png" alt="" width="611" height="314" /></p>
<p style="text-align: center;">Figura 62: "FrontEnd Simple: Listado de Trámites participados"</p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 1,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1353587279,
    'editedby' => 2,
    'editedon' => 1369084057,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1353587220,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Perfil Registrados</title>
    <!-- Bootstrap -->
...
<li><a href="simple/backend/" title="Backend" >Backend</a><ul><li class="first"><a href="simple/backend/ingreso.html" title="Ingreso" >Ingreso</a></li>
...
<li class="active"><a href="simple/frontend/" title="Frontend" >Frontend</a><ul><li class="first active"><a href="simple/frontend/ingreso/" title="Ingreso" >Ingreso</a><ul><li class="first"><a href="simple/frontend/ingreso/perfil-publico.html" title="Perfil Público" >Perfil Público</a></li>
<li class="active current"><a href="simple/frontend/ingreso/perfil-registrados.html" title="Perfil Registrados" >Perfil Registrados</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/frontend/">Frontend</a> <span class="divider">/</span></li><li><a href="simple/frontend/ingreso/">Ingreso</a> <span class="divider">/</span></li><li>Perfil Registrados</li>
</ul>
				<h3>3.1.2      Perfil de Usuarios Registrados: Ciudadanos y Usuarios Comunes - Ventana Principal</h3>
<p> </p>
<p>Como se ha comentado en la sección anterior, existen reclamos para los cuales se requiere cierta información especial, privada o el trámite por normativa no es posible acceder de manera generalizada al Portal de Simple, para esto es necesario que el Ciudadano / Usuario inicie sesión en el Portal de Simple, actualmente existen dos formas para el ingreso al Portal Simple: registrándose directamente en el Portal de Simple, o si posee ClaveÚnica acceder directamente con ella, siendo este último método la forma de validar realmente que quien realice el trámite sea realmente quien dice ser. En el recuadro en rojo de la imagen siguiente se indica la sección en donde se podrá registrar y/o acceder al portal:</p>
<p> </p>
<p style="text-align: center;">  <img src="assets/img/FrontEnd/frontendf3.png" alt="" width="454" height="141" /></p>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
    ...
    '[[$breadcrumbLinkCrumbTpl?id=`2`&type=`document`&contentType=`text/html`&pagetitle=`Simple`&longtitle=``&description=``&alias=`simple`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`0`&isfolder=`1`&introtext=``&content=`<p>Bienvenido al manual de Simple.</p>`&richtext=`1`&template=`1`&menuindex=`1`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2012-11-20 20:55:38`&editedby=`1`&editedon=`2012-11-21 14:36:41`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2012-11-20 20:56:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=`simple/`&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`85e0b0ffdd9f7fb03a296ee6729bc7ba`&link=`simple/`]]' => '<li><a href="simple/">Simple</a> <span class="divider">/</span></li>',
    '[[$breadcrumbLinkCrumbTpl?id=`19`&type=`document`&contentType=`text/html`&pagetitle=`Frontend`&longtitle=``&description=``&alias=`frontend`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`2`&isfolder=`1`&introtext=``&content=``&richtext=`1`&template=`1`&menuindex=`2`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2012-11-21 14:24:36`&editedby=`0`&editedon=`0`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2012-11-21 14:24:36`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=`simple/frontend/`&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`4a841b6619e7a4737402ec898deee88b`&link=`simple/frontend/`]]' => '<li><a href="simple/frontend/">Frontend</a> <span class="divider">/</span></li>',
    '[[$breadcrumbLinkCrumbTpl?id=`20`&type=`document`&contentType=`text/html`&pagetitle=`Ingreso`&longtitle=``&description=``&alias=`ingreso`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`19`&isfolder=`1`&introtext=``&content=``&richtext=`1`&template=`1`&menuindex=`0`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2012-11-21 14:24:57`&editedby=`2`&editedon=`2013-05-20 21:08:55`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2012-11-21 14:24:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=`simple/frontend/ingreso/`&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`14a0a71d580b7009d0eec45019a1f7db`&link=`simple/frontend/ingreso/`]]' => '<li><a href="simple/frontend/ingreso/">Ingreso</a> <span class="divider">/</span></li>',
    '[[$breadcrumbContainerTpl?crumbs=`<li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/frontend/">Frontend</a> <span class="divider">/</span></li><li><a href="simple/frontend/ingreso/">Ingreso</a> <span class="divider">/</span></li><li>Perfil Registrados</li>`]]' => '<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/frontend/">Frontend</a> <span class="divider">/</span></li><li><a href="simple/frontend/ingreso/">Ingreso</a> <span class="divider">/</span></li><li>Perfil Registrados</li>
</ul>',
