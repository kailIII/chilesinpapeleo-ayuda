<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h3>3.1.1       Perfil Público de Ingreso Público a Portal Simple</h3>
<p>En este caso y a modo de ejemplo se ingresará a la dirección desde el navegador (browser) de preferencia: <a href="http://simple.chilesinpapeleo.cl/"><strong>http://simple.chilesinpapeleo.cl/</strong></a> una vez realizado se desplegará una imagen como la siguiente:</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf1.png" alt="" width="454" height="255" /></p>
<p style="text-align: center;">Figura 55: "Portal Simple FrontEnd"</p>
<p style="text-align: center;"> </p>
<p>En la imagen anterior  se visualizan los trámites públicos de la Institución que se pueden realizar dentro de Simple, para iniciar un nuevo trámite sólo debe hacer clic sobre el botón <img src="assets/img/FrontEnd/frontendf2.png" alt="" width="66" height="23" />  y el trámite seleccionado iniciará su proceso de gestión. Como se habrá percatado, en el listado público no se encuentran todos los trámites realizables por la Institución, esto se debe a que al acceder directamente a la URL, la ventana de inicio desplegará únicamente los trámites en los cuales el Modelo de Procesos permita en la tarea inicial que se puede acceder por cualquier tipo de usuario, esto por la existencia de trámites que requieren de información privada o sensible los cuales requieren un registro previo.</p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 0,
    'searchable' => 1,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Perfil Público</title>
    <!-- Bootstrap -->
...
<li class="active"><a href="simple/frontend/" title="Frontend" >Frontend</a><ul><li class="first active"><a href="simple/frontend/ingreso/" title="Ingreso" >Ingreso</a><ul><li class="first active current"><a href="simple/frontend/ingreso/perfil-publico.html" title="Perfil Público" >Perfil Público</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/frontend/">Frontend</a> <span class="divider">/</span></li><li><a href="simple/frontend/ingreso/">Ingreso</a> <span class="divider">/</span></li><li>Perfil Público</li>
</ul>
				<h3>3.1.1       Perfil Público de Ingreso Público a Portal Simple</h3>
<p>En este caso y a modo de ejemplo se ingresará a la dirección desde el navegador (browser) de preferencia: <a href="http://simple.chilesinpapeleo.cl/"><strong>http://simple.chilesinpapeleo.cl/</strong></a> una vez realizado se desplegará una imagen como la siguiente:</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf1.png" alt="" width="454" height="255" /></p>
<p style="text-align: center;">Figura 55: "Portal Simple FrontEnd"</p>
