...
<p>El presente manual está dirigido a desarrolladores, en el cual se indicarán los fundamentos funcionales y las directrices para la correcta integración de ClaveÚnica sobre Sitios Web.</p>
<p>Lo que se espera sobre la implementación de ClaveÚnica, es que los Sitios Web Gubernamentales y/o Sitios de terceras partes permitan la autenticación de las personas chilenas de manera centralizada mediante el Registro Civil, esto quiere decir que ClaveÚnica libera a las personas de manejar diferentes cuentas (usuarios y password) para el ingreso y registro entre los distintos Sitios Web, además de permitirles autenticarse como una persona chilena. También libera a los desarrolladores y administradores del Sitio Web de la labor de almacenar y administrar contraseñas de cada persona.</p>
<p><strong> </strong></p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 1,
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1355251439,
    'editedby' => 1,
    'editedon' => 1355256469,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1355256469,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Introducción</title>
    <!-- Bootstrap -->
    ...
    <body>
		<div class="container">
			...
			<div class="row">
				<div class="span4">
				<div class="well">
				<ul><li class="first active current"><a href="claveunica/introduccion.html" title="Introducción" >Introducción</a></li>
...
<li class="last"><a href="claveunica/anexos.html" title="Anexos" >Anexos</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="claveunica.html">ClaveÚnica</a> <span class="divider">/</span></li><li>Introducción</li>
</ul>
				<p><strong> </strong></p>
<h1>1         Introducción</h1>
<p>El presente manual está dirigido a desarrolladores, en el cual se indicarán los fundamentos funcionales y las directrices para la correcta integración de ClaveÚnica sobre Sitios Web.</p>
...
<p><strong> </strong></p>
  ...
  array (
    '[[*pagetitle]]' => 'Introducción',
    '[[UltimateParent]]' => '36',
    '[[Wayfinder? &startId=`36` &selfClass=`current` ]]' => '<ul><li class="first active current"><a href="claveunica/introduccion.html" title="Introducción" >Introducción</a></li>
<li><a href="claveunica/claveunica.html" title="ClaveÚnica" >ClaveÚnica</a><ul><li class="first"><a href="claveunica/claveunica/proceso-de-autenticacion-openid.html" title="Proceso de Autenticación OpenID" >Proceso de Autenticación OpenID</a></li>
</ul></li>
<li><a href="claveunica/integracion-de-claveunica-con-su-sitio-web.html" title="Integración de ClaveÚnica con su Sitio Web" >Integración de ClaveÚnica con su Sitio Web</a></li>
<li><a href="claveunica/ejemplos-de-integracion.html" title="Ejemplos de Integración" >Ejemplos de Integración</a></li>
