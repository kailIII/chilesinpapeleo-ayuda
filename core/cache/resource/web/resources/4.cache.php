<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1353504521,
    'editedby' => 1,
    'editedon' => 1353511134,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1353504480,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Backend</title>
    <!-- Bootstrap -->
...
<li class="active current"><a href="simple/backend/" title="Backend" >Backend</a><ul><li class="first"><a href="simple/backend/ingreso.html" title="Ingreso" >Ingreso</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li>Backend</li>
</ul>
				<p>El BackEnd de Simple, posee una serie de funcionalidades importantes, destacando la realización del diseño de los procesos para los trámites a digitalizar, el seguimiento y reporte de los procesos. Se debe tener en cuenta que BackEnd no es visible y no lo utilizan los usuarios finales, se requieren de accesos especiales para su ingreso.</p>
				</div>
			</div>
