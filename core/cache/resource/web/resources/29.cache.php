<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p><iframe style="display: block; margin-left: auto; margin-right: auto;" src="http://player.vimeo.com/video/54527088?badge=0" frameborder="0" width="500" height="375"></iframe></p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 3,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1354201686,
    'editedby' => 1,
    'editedon' => 1354203701,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1354201680,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Parte 4: Generación de Documentos y Certificados</title>
    <!-- Bootstrap -->
...
<li class="last active"><a href="simple/video-tutoriales/" title="Video Tutoriales" >Video Tutoriales</a><ul><li class="first"><a href="simple/video-tutoriales/parte-1-introduccion.html" title="Parte 1: Introducción" >Parte 1: Introducción</a></li>
...
<li class="active current"><a href="simple/video-tutoriales/parte-4-generacion-de-documentos-y-certificados.html" title="Parte 4: Generación de Documentos y Certificados" >Parte 4: Generación de Documentos y Certificados</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/video-tutoriales/">Video Tutoriales</a> <span class="divider">/</span></li><li>Parte 4: Generación de Documentos y Certificados</li>
</ul>
				<p><iframe style="display: block; margin-left: auto; margin-right: auto;" src="http://player.vimeo.com/video/54527088?badge=0" frameborder="0" width="500" height="375"></iframe></p>
				</div>
			</div>
		</div>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
    ...
    '[[$breadcrumbLinkCrumbTpl?id=`2`&type=`document`&contentType=`text/html`&pagetitle=`Simple`&longtitle=``&description=``&alias=`simple`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`0`&isfolder=`1`&introtext=``&content=`<p>Bienvenido al manual de Simple.</p>`&richtext=`1`&template=`1`&menuindex=`1`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2012-11-20 20:55:38`&editedby=`1`&editedon=`2012-11-21 14:36:41`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2012-11-20 20:56:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=`simple/`&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`7c0865056267ca7363d1003cc77f4472`&link=`simple/`]]' => '<li><a href="simple/">Simple</a> <span class="divider">/</span></li>',
    '[[$breadcrumbLinkCrumbTpl?id=`25`&type=`document`&contentType=`text/html`&pagetitle=`Video Tutoriales`&longtitle=``&description=``&alias=`video-tutoriales`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`2`&isfolder=`1`&introtext=``&content=`<p>[[Wayfinder]]</p>`&richtext=`1`&template=`1`&menuindex=`3`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2012-11-29 14:50:30`&editedby=`1`&editedon=`2012-11-29 15:47:30`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2012-11-29 14:50:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=`simple/video-tutoriales/`&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`90fb55b33651644a8b61215c8dfa4568`&link=`simple/video-tutoriales/`]]' => '<li><a href="simple/video-tutoriales/">Video Tutoriales</a> <span class="divider">/</span></li>',
    '[[$breadcrumbContainerTpl?crumbs=`<li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/video-tutoriales/">Video Tutoriales</a> <span class="divider">/</span></li><li>Parte 4: Generación de Documentos y Certificados</li>`]]' => '<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/video-tutoriales/">Video Tutoriales</a> <span class="divider">/</span></li><li>Parte 4: Generación de Documentos y Certificados</li>
</ul>',
