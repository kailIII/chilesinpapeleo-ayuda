<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>El concepto de Grupo de Usuarios dentro de Simple, corresponde a la agrupación de usuarios que tengan un mismo rol o función dentro del modelo de procesos definido, para luego poder asociarlos a las diferentes tareas que se realicen dentro del proceso.</p>
<p>Para definir los accesos a los Grupos de Usuarios, es necesario hacer clic sobre <em>Configuración</em> y luego <em>Grupos de Usuarios</em>, con lo cual se desplegará una imagen como la siguiente:</p>
<p><img src="assets/img/BackEnd/Configuracion/grupos_usuarios.png" alt="" width="862" height="322" /></p>
<p> </p>
<p>Se pueden ven una serie de opciones principales del mantenedor:</p>
<ul>
<li>Botón <em>Nuevo <img src="assets/img/boton-nuevo.png" alt="" width="58" height="23" /></em>:
<ul>
<li>Permite generar un nuevo grupo de usuarios. Para esto, sólo deberá indicar el nombre del grupo en el siguiente recuadro<br /><br /><img style="display: block; margin-left: auto; margin-right: auto;" src="assets/img/grupos2.png" alt="Ventana Edicion Grupo de Usuario" width="353" height="415" /><br />Tenga en cuenta que puede asignar usuarios al nuevo grupo inmediatamente, siempre y cuando los usuarios ya los haya añadido al sistema.</li>
</ul>
</li>
</ul>
<ul>
<li>Botón <em>Editar <img src="assets/img/boton-editar.png" alt="" width="53" height="21" /></em>:
<ul>
<li>Permite remplazar el nombre del grupo existente. Para esto sólo debe presionar el botón ‘Editar’, de la misma fila en que se encuentre el grupo a editar, como se visualiza a continuación:<br /><img src="assets/img/BackEnd/Configuracion/editar_grupo.png" alt="" width="802" height="268" /><br />
<p><br />Luego completar el formulario que se abrirá, el cual contendrá el nombre actual del grupo y sus integrantes:<br /><img style="display: block; margin-left: auto; margin-right: auto;" src="assets/img/BackEnd/Configuracion/editar_grupo2.png" alt="" width="312" height="334" /></p>
<p><br />Una vez renombrado el nombre del grupo, simplemente presione Guardar. </p>
</li>
</ul>
</li>
</ul>
<ul>
<li>Botón <em>Eliminar <img src="assets/img/boton-eliminar.png" alt="" width="55" height="22" /></em>:
<ul>
<li>Permite eliminar un grupo previamente añadido a Simple, debe tener especial cuidado al utilizar esta opción, ya que eliminar un grupo asignado a un proceso, el proceso quedará sin asignación.<br /><br />Para eliminar un grupo simplemente posiciónese en la fila del grupo a eliminar y presione el botón <em>Eliminar</em>. A modo de ejemplo, imagen siguiente se eliminará el grupo <em>terting</em>:<br /><img src="assets/img/BackEnd/Configuracion/editar_grupo.png" alt="" width="802" height="268" /></li>
</ul>
</li>
</ul>',
    'richtext' => 1,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Grupos</title>
    <!-- Bootstrap -->
...
<li class="active current"><a href="simple/backend/configuracion/grupos.html" title="Grupos" >Grupos</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li><a href="simple/backend/configuracion/">Configuración</a> <span class="divider">/</span></li><li>Grupos</li>
</ul>
				<p>El concepto de Grupo de Usuarios dentro de Simple, corresponde a la agrupación de usuarios que tengan un mismo rol o función dentro del modelo de procesos definido, para luego poder asociarlos a las diferentes tareas que se realicen dentro del proceso.</p>
<p>Para definir los accesos a los Grupos de Usuarios, es necesario hacer clic sobre <em>Configuración</em> y luego <em>Grupos de Usuarios</em>, con lo cual se desplegará una imagen como la siguiente:</p>
<p><img src="assets/img/BackEnd/Configuracion/grupos_usuarios.png" alt="" width="862" height="322" /></p>
<p> </p>
<p>Se pueden ven una serie de opciones principales del mantenedor:</p>
