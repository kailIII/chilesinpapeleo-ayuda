<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h2>2.6                 Pantalla inicio - Widgets</h2>
<p>Existen Widgets predefinidos en el sistema que permiten entregar gráficos estadísticos ya sea por etapa actual del trámite o por el estado del trámite (completados/pendientes), actualizados en tiempo real de los movimientos de los procesos generados para los procesos, estos gráficos los puede ubicar en la pantalla de inicio al haber ingresado a SIMPLE como usuario BackEnd.</p>
<p> </p>
<p>Esta se encuentra en el menú inicio, por lo que para acceder deberá hacer clic sobre la pestaña <em>Inicio</em>. Como se indica en la imagen siguiente:</p>
<p> </p>
<p><img src="assets/img/BackEnd/Widgets/Figura52-WI.png" alt="" width="454" height="145" /></p>
<p>Figura 52: "Ventana de Inicio - Widget"</p>
<p> </p>
<p>Luego haga clic sobre <em>Nuevo Widget </em> <em> </em>y seleccionar el tipo de Widget que desea ingresar a su menú de inicio. Al realizar esta acción se le indicará que el Widget requiere de configuración, para configurarlo simplemente haga clic sobre el icono marcado en el recuadro rojo de la siguiente imagen:</p>
<p> </p>
<p><img src="assets/img/BackEnd/Widgets/Figura53-WI.png" alt="" width="151" height="87" /> </p>
<p>Figura 53: "Botón de Configuración del Widget"</p>
<p> </p>
<p>Finalmente, simplemente ingrese el <em>nombre del Widget</em>, seleccione el <em>proceso </em>asociado y pulse el botón <em>Ok</em>.</p>
<p> </p>
<p><img src="assets/img/BackEnd/Widgets/Figura54-WI.png" alt="" width="151" height="144" /></p>
<p>Figura 54: "Parametrización básica de Widget"</p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 4,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1353507857,
    'editedby' => 2,
    'editedon' => 1369086107,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1353507840,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Widgets</title>
    <!-- Bootstrap -->
...
<li class="last active current"><a href="simple/backend/widgets.html" title="Widgets" >Widgets</a></li>
</ul></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li>Widgets</li>
</ul>
				<h2>2.6                 Pantalla inicio - Widgets</h2>
<p>Existen Widgets predefinidos en el sistema que permiten entregar gráficos estadísticos ya sea por etapa actual del trámite o por el estado del trámite (completados/pendientes), actualizados en tiempo real de los movimientos de los procesos generados para los procesos, estos gráficos los puede ubicar en la pantalla de inicio al haber ingresado a SIMPLE como usuario BackEnd.</p>
<p> </p>
<p>Esta se encuentra en el menú inicio, por lo que para acceder deberá hacer clic sobre la pestaña <em>Inicio</em>. Como se indica en la imagen siguiente:</p>
<p> </p>
