<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>Para ingresar al BackEnd de Simple es necesario que el usuario gestione sus permisos de acceso al portal junto a la Unidad de Modernización y Gobierno Digital, quienes le indicarán sus credenciales y dirección (URL) de acceso a Simple para la Institución que representa. Una vez que tenga esta información podrá realizar el ingreso al portal. En este caso y a modo de ejemplo se ingresará a la dirección desde el navegador (browser) de preferencia: <a href="http://simple.chilesinpapeleo.cl/backend"><strong>http://simple.chilesinpapeleo.cl/backend</strong></a>, una vez realizado se desplegará una imagen como la siguiente:</p>
<p><img src="assets/img/ingreso.png" alt="Ingreso al Sistema" width="886" height="598" /></p>
<p> </p>
<p>Luego deberá ingresar sus credenciales (Usuario y Contraseña) en los campos indicados. Tenga presente haber gestionado sus credenciales previamente, para la generación o edición de nuevos procesos.</p>
<p><img style="display: block; margin-left: auto; margin-right: auto;" src="assets/img/ingreso2.png" alt="Ingreso de credenciales para Ingreso al Sistema" width="280" height="314" /></p>
<p> </p>
<p>Al presionar el botón <em>Ingresar</em>, se desplegará la pantalla de inicio de Simple, siendo la pestaña de inicio la pestaña inicial. Como se visualiza en la imagen siguiente:</p>
<p><img src="assets/img/ingreso3.png" alt="Pantalla de inicial del BackEnd de Simple" width="709" height="274" /></p>
<p> </p>
<p>La ventana de trabajo se encuentra estructurada de la siguiente forma:</p>
<p><img src="assets/img/ingreso4.png" alt="Marco de Trabajo para el BackEnd de Simple" width="709" height="363" /></p>
<p> </p>
<p>Cada uno de los recuadros demarcados en rojo representa lo siguiente:</p>
<ul>
<li>El recuadro superior indica el usuario que ha ingresado al Sistema. Si hace clic sobre nombre de usuario se dará la opción de Cerrar Sesión.</li>
<li>En recuadro central se visualizan las opciones para el desarrollo y seguimiento de Procesos de Simple. Cada una de estas opciones serán vistas individualmente dentro del manual.</li>
<li>El recuadro inferior corresponde al área de trabajo de Simple, en este caso la imagen representa la pantalla inicial de Simple.</li>
</ul>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1353504549,
    'editedby' => 1,
    'editedon' => 1353511671,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1353504540,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Ingreso</title>
    <!-- Bootstrap -->
...
<li class="active"><a href="simple/backend/" title="Backend" >Backend</a><ul><li class="first active current"><a href="simple/backend/ingreso.html" title="Ingreso" >Ingreso</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li>Ingreso</li>
</ul>
				<p>Para ingresar al BackEnd de Simple es necesario que el usuario gestione sus permisos de acceso al portal junto a la Unidad de Modernización y Gobierno Digital, quienes le indicarán sus credenciales y dirección (URL) de acceso a Simple para la Institución que representa. Una vez que tenga esta información podrá realizar el ingreso al portal. En este caso y a modo de ejemplo se ingresará a la dirección desde el navegador (browser) de preferencia: <a href="http://simple.chilesinpapeleo.cl/backend"><strong>http://simple.chilesinpapeleo.cl/backend</strong></a>, una vez realizado se desplegará una imagen como la siguiente:</p>
<p><img src="assets/img/ingreso.png" alt="Ingreso al Sistema" width="886" height="598" /></p>
<p> </p>
<p>Luego deberá ingresar sus credenciales (Usuario y Contraseña) en los campos indicados. Tenga presente haber gestionado sus credenciales previamente, para la generación o edición de nuevos procesos.</p>
<p><img style="display: block; margin-left: auto; margin-right: auto;" src="assets/img/ingreso2.png" alt="Ingreso de credenciales para Ingreso al Sistema" width="280" height="314" /></p>
