<?php  return array (
  ...
  array (
    ...
    'introtext' => '',
    'content' => '<p> </p>
<h1>4         Ejemplos de Integración</h1>
<p>En general la integración de cualquier Sitio Web con clave única se representa de la siguiente forma:</p>
<p align="center"><img src="assets/img/ClaveUnica/flujo%20clave%20unica.png" alt="" width="557" height="504" /> </p>
<p>Figura 4: "Diagrama de Integración Sitio Web - ClaveÚnica"</p>
<p> </p>
<p>En general el desarrollo del Sitio Web deberá contener para la integración de ClaveÚnica las siguientes páginas:</p>
<ul>
<li><strong>claveunica.png</strong>: Corresponde al botón oficial para ClaveÚnica, en este botón tiene que estar la acción <em>request</em>.</li>
<li><strong>Index</strong>: página de su Sitio Web. Habitualmente corresponde al portal o home.</li>
<li><strong>Openid</strong>: Habitualmente corresponde al nombre de la librería OpenId, dependiendo del lenguaje utilizado la extensión podrá ser .php, .jar, etc.</li>
<li><strong>Request</strong>: Corresponderá al archivo que genere la solicitud hacia www.claveunica.cl</li>
<li><strong>Return</strong>: Una vez que ClaveÚnica responde el resultado de autorización, en esta página se validan los resultados, si se ha autentificado correctamente,  se obtienen los parámetros que se entregan desde www.claveunica.cl, se y debe generar la sesión de la persona en caso de que se haya autentificado correctamente y finalmente se redirige a la página de su Sitio Web de destino que haya requerido la autentificación.</li>
</ul>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 4,
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1355252004,
    'editedby' => 2,
    'editedon' => 1355256979,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1355256979,
    'publishedby' => 2,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Ejemplos de Integración</title>
    <!-- Bootstrap -->
...
<li><a href="claveunica/claveunica.html" title="ClaveÚnica" >ClaveÚnica</a><ul><li class="first"><a href="claveunica/claveunica/proceso-de-autenticacion-openid.html" title="Proceso de Autenticación OpenID" >Proceso de Autenticación OpenID</a></li>
</ul></li>
...
<li class="active current"><a href="claveunica/ejemplos-de-integracion.html" title="Ejemplos de Integración" >Ejemplos de Integración</a></li>
<li class="last"><a href="claveunica/anexos.html" title="Anexos" >Anexos</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="claveunica.html">ClaveÚnica</a> <span class="divider">/</span></li><li>Ejemplos de Integración</li>
</ul>
				<p> </p>
<h1>4         Ejemplos de Integración</h1>
<p>En general la integración de cualquier Sitio Web con clave única se representa de la siguiente forma:</p>
