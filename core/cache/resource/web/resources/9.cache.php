<?php  return array (
  ...
  array (
    ...
    'introtext' => '',
    'content' => '<p> </p>
<p><span style="text-decoration: underline;"><strong>USUARIO ACCESO FRONTEND</strong></span></p>
<p>Un usuario de acceso frontend corresponde a quien interactuará con el modelo de procesos de diversas formas, habitualmente un usuario puede pertenecer a un uno o más grupos para la correcta gestión del proceso.</p>
<p>Para ingresar a la opción para la Gestión de Usuarios frontend, es necesario hacer clic sobre <em>Configuración</em> y luego <em>Usuarios </em>del menú<em> Acceso Frontend</em>, con lo cual se desplegará una imagen como la siguiente:</p>
<p><img src="assets/img/BackEnd/Configuracion/usuario_frontend.png" alt="" width="940" height="314" /></p>
<p>Siendo las opciones del mantenedor de Usuarios las siguientes:</p>
<ul>
<li>Botón <em>Nuevo <img src="assets/img/boton-nuevo.png" alt="" width="53" height="21" /></em>:
<ul>
<li>Permite añadir un nuevo usuario a Simple. Para esto, sólo debe hacer clic sobre el botón <em>Nuevo</em> y completar el formulario que se desplegará, con se ve en la imagen siguiente:<br /><img style="display: block; margin-left: auto; margin-right: auto;" src="assets/img/IngresoUsuarios.jpg" alt="Marco para el Ingreso de Usuario" width="250" height="624" /></li>
</ul>
</li>
</ul>
<p> </p>
<p><img style="display: block; margin-left: auto; margin-right: auto;" src="assets/img/SeccionFueraOficina.jpg" alt="" width="246" height="26" /></p>
<p>Puede checkear el ticket "¿Fuera de oficina?" para indicar que el usuario no se encuentra disponible, con esto las tareas no será asignadas a él.</p>
<p> </p>
<p>Considere que un usuario puede pertenecer a más de un grupo, por lo que en el campo <em>Grupos de Usuario</em>, se le desplegará una lista con los grupos existentes en Simple, como se puede visualizar en la siguiente imagen:</p>
<ul>
<li>
<ul>
<li><img style="display: block; margin-left: auto; margin-right: auto;" src="assets/img/usuarios3.png" alt="" width="287" height="168" /><br /><br />El ingreso de usuarios se puede realizar en el momento que se requiera al diseñar el modelo de proceso, pero es recomendable definirlos con anterioridad, esto permitirá que en momento del diseño del modelo de procesos, los usuarios o grupos sean asignados inmediatamente a las tareas que correspondan.</li>
</ul>
<p> </p>
</li>
</ul>
<ul>
<li>Botón <em>Editar <img src="assets/img/boton-editar.png" alt="" width="45" height="18" /></em>:
<ul>
<li>Permite editar los datos de un usuario en particular existente en Simple. Para esto sólo debe presionar el botón <em>Editar</em>, dentro de la misma fila en que se encuentre el usuario a editar, como se visualiza a continuación:<br /><br /><img src="assets/img/BackEnd/Configuracion/usuario_frontend2.png" alt="" width="866" height="289" /><br /><br />Luego completar el formulario que se abrirá, el cual contiene el mismo formulario que se ha completado al momento de añadir un nuevo usuario, sólo que en esta oportunidad los datos aparecerán precargados, para poder ser editados:<br /><br /><img src="assets/img/BackEnd/Configuracion/editar_usuario.png" alt="" width="277" height="625" /><br /><br />Como se puede visualizar en el formulario anterior, el campo Contraseña no tendrá información precargada, si desea cambiar la contraseña deberá modificar dicho campo, de lo contrario, lo debe dejar en blanco para mantener la contraseña actual del usuario.</li>
</ul>
</li>
</ul>
<p> </p>
<ul>
<li>Botón <em>Eliminar <img src="assets/img/boton-eliminar.png" alt="" width="63" height="25" /></em>:
<ul>
<li>Permite eliminar un usuario del Sistema. Para eliminar un usuario simplemente posiciónese en la fila del usuario a eliminar y haga clic sobre el botón <em>Eliminar</em>. A modo de ejemplo en la imagen de a continuación se eliminará el usuario <em>sbmsbm</em>:<br /><br /><img src="assets/img/BackEnd/Configuracion/usuario_frontend2.png" alt="" width="856" height="286" /><br /><br />
<p>Se desplegará una imagen de confirmación previa eliminación del usuario, confirmando esto el usuario será eliminado definitivamente:<br /><br /><img style="display: block; margin-left: auto; margin-right: auto;" src="assets/img/usuarios7.png" alt="PopUp confirmación de Eliminación" width="448" height="276" /></p>
<p> </p>
<p> </p>
</li>
</ul>
...
<p><span style="text-decoration: underline;"><strong>USUARIO ACCESO BACKEND</strong></span></p>
<p>Los usuarios de acceso backend corresponden a usuarios de administracion del sitio SIMPLE. La gestion y administracion de usuarios backend se realiza de la misma forma que los usuarios del Frontend. La particularidad es que pueden crearse con distintos roles  los cuales permiten acceso restringido  a ciertas funcionalidades, a continuación se detallan los distintos tipos de  roles de usuarios backend.</p>
<ul>
<li>Super: Acceso a todas las funionalidades de la administración.</li>
<li>Modelamiento: Solo acceso a la funcionalidad <strong>Modelador de Procesos</strong>.</li>
<li>Operación: Solo acceso a la funcionalidad <strong>Seguimiento</strong>.</li>
<li>Gestión: Acceso a la funcionalidad  <strong>Gestión</strong> y a los Widget de la página de inicio.</li>
</ul>
<p> </p>
<p><img src="assets/img/BackEnd/Configuracion/usuario_backend.png" alt="" width="962" height="421" /></p>
<p> </p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 2,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1353504645,
    'editedby' => 2,
    'editedon' => 1369619470,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1353504600,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Usuarios</title>
    <!-- Bootstrap -->
...
<li class="active"><a href="simple/backend/configuracion/" title="Configuración" >Configuración</a><ul><li class="first"><a href="simple/backend/configuracion/inicial.html" title="Inicial" >Inicial</a></li>
<li><a href="simple/backend/configuracion/grupos.html" title="Grupos" >Grupos</a></li>
<li class="last active current"><a href="simple/backend/configuracion/usuarios.html" title="Usuarios" >Usuarios</a></li>
</ul></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li><a href="simple/backend/configuracion/">Configuración</a> <span class="divider">/</span></li><li>Usuarios</li>
</ul>
				<p> </p>
<p><span style="text-decoration: underline;"><strong>USUARIO ACCESO FRONTEND</strong></span></p>
<p>Un usuario de acceso frontend corresponde a quien interactuará con el modelo de procesos de diversas formas, habitualmente un usuario puede pertenecer a un uno o más grupos para la correcta gestión del proceso.</p>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
    ...
    '[[$breadcrumbLinkCrumbTpl?id=`2`&type=`document`&contentType=`text/html`&pagetitle=`Simple`&longtitle=``&description=``&alias=`simple`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`0`&isfolder=`1`&introtext=``&content=`<p>Bienvenido al manual de Simple.</p>`&richtext=`1`&template=`1`&menuindex=`1`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2012-11-20 20:55:38`&editedby=`1`&editedon=`2012-11-21 14:36:41`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2012-11-20 20:56:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=`simple/`&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`313e708cdf758a5bdf224f574737ea54`&link=`simple/`]]' => '<li><a href="simple/">Simple</a> <span class="divider">/</span></li>',
    '[[$breadcrumbLinkCrumbTpl?id=`4`&type=`document`&contentType=`text/html`&pagetitle=`Backend`&longtitle=``&description=``&alias=`backend`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`2`&isfolder=`1`&introtext=``&content=`<p>El BackEnd de Simple, posee una serie de funcionalidades importantes, destacando la realización del diseño de los procesos para los trámites a digitalizar, el seguimiento y reporte de los procesos. Se debe tener en cuenta que BackEnd no es visible y no lo utilizan los usuarios finales, se requieren de accesos especiales para su ingreso.</p>`&richtext=`1`&template=`1`&menuindex=`1`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2012-11-21 13:28:41`&editedby=`1`&editedon=`2012-11-21 15:18:54`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2012-11-21 13:28:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=`simple/backend/`&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`4ff93d9c9a5fa6db5d293d3b08efd11e`&link=`simple/backend/`]]' => '<li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li>',
    '[[$breadcrumbLinkCrumbTpl?id=`6`&type=`document`&contentType=`text/html`&pagetitle=`Configuración`&longtitle=``&description=``&alias=`configuracion`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`4`&isfolder=`1`&introtext=``&content=`<p>Cuando se habla de configuración en Simple se refiere a la gestión de usuarios y grupos de usuarios, tanto para generar nuevos o gestionar los existentes, esta configuración aplica únicamente para el proceso en el cual se está trabajando, no afecta otros procesos. Como se verá en este apartado.</p>`&richtext=`1`&template=`1`&menuindex=`1`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2012-11-21 13:29:30`&editedby=`1`&editedon=`2012-11-21 18:46:25`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2012-11-21 13:29:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=`simple/backend/configuracion/`&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`cd5571b6654864f192de5830e5db78a0`&link=`simple/backend/configuracion/`]]' => '<li><a href="simple/backend/configuracion/">Configuración</a> <span class="divider">/</span></li>',
    '[[$breadcrumbContainerTpl?crumbs=`<li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li><a href="simple/backend/configuracion/">Configuración</a> <span class="divider">/</span></li><li>Usuarios</li>`]]' => '<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li><a href="simple/backend/configuracion/">Configuración</a> <span class="divider">/</span></li><li>Usuarios</li>
</ul>',
