<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h3>2.3.2                Generación de Formularios para el Proceso</h3>
<p>Los formularios permiten ingresar datos de una forma amigable y estructurada dentro de Simple por parte de los diversos involucrados del modelo de proceso, dada su relevancia es importante definir la estructura que tendrá cada uno de los formularios a utilizar, antes de diagramar el modelo de procesos. Para gestionar los formularios haga clic en Formularios dentro del menú de Modelador de Proceso, tal como se visualiza en la imagen siguiente:</p>
<p>  </p>
<p><img src="assets/img/BackEnd/Generacion-Formularios/Figura29-GF.png" alt="" width="804" height="330" /></p>
<p>Figura 29: "Modelador de Procesos - Formularios"</p>
<p> </p>
<ul>
<li>Botón <em>Nuevo </em>:
<ul>
<li>Permite generar un nuevo formulario para el modelo de procesos que se está trabajando dentro de Simple. Al presionar sobre el botón ingresará a la ventana de trabajo para la generación y diseño de formularios.</li>
</ul>
</li>
</ul>
<ul>
...
<ul>
<li>Permite modificar un formulario existente en Simple, al ingresar a esta opción ingresará a la ventana de trabajo para diseñar formularios.</li>
</ul>
  </li>
<li><em>Botón Eliminar</em></li>
<ul>
<li>Permite eliminar un formulario existente en Simple, para esto haga clic sobre la fila con el formulario a eliminar y pulse el botón Eliminar, con esto el formulario quedará eliminado del sistema. Tenga en cuenta que esta operación no es reversible y recuerde validar el modelo de procesos que no se encuentre utilizando el formulario a eliminar.</li>
</ul>
</ul>
<p><em> </em></p>',
    'richtext' => 1,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Generación de Formularios</title>
    <!-- Bootstrap -->
...
<li class="active current"><a href="simple/backend/modelamiento-del-proceso/generacion-de-formularios.html" title="Generación de Formularios" >Generación de Formularios</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li><a href="simple/backend/modelamiento-del-proceso/">Modelamiento del Proceso</a> <span class="divider">/</span></li><li>Generación de Formularios</li>
</ul>
				<h3>2.3.2                Generación de Formularios para el Proceso</h3>
<p>Los formularios permiten ingresar datos de una forma amigable y estructurada dentro de Simple por parte de los diversos involucrados del modelo de proceso, dada su relevancia es importante definir la estructura que tendrá cada uno de los formularios a utilizar, antes de diagramar el modelo de procesos. Para gestionar los formularios haga clic en Formularios dentro del menú de Modelador de Proceso, tal como se visualiza en la imagen siguiente:</p>
<p>  </p>
<p><img src="assets/img/BackEnd/Generacion-Formularios/Figura29-GF.png" alt="" width="804" height="330" /></p>
<p>Figura 29: "Modelador de Procesos - Formularios"</p>
