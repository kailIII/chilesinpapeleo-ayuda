<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h3>3.1.3      Perfil de Usuarios Institucionales: Participantes de la gestión y realización de un Trámite - Ventana Principal</h3>
<p> </p>
<p>Al ingresar un usuario registrado al portal y este además tiene privilegios especiales dado por el generador de Modelo de Procesos,  se desplegará una ventana con las operaciones disponibles similar que la ventana de trabajo para usuarios registrados, como se visualiza en la siguiente imagen:</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf15.png" alt="" width="523" height="255" /></p>
<p style="text-align: center;">Figura 63: "FrontEnd Simple – Ventana Principal de Usuarios Registrados"</p>
<p> </p>
<p>Dentro del bloque central de la ventana se despliega el listado de los trámites que pueden realizar los usuarios públicos, los usuarios registrados y los usuarios asignados directamente. Mientras que en el bloque de la izquierda, será posible gestionar los trámites visualizando los trámites que están en bandeja de entrada, los trámites sin asignar y los trámites que el usuario registrado ha participado. A continuación se explicarán cada una de las opciones de los enlaces.</p>
<p> </p>
<p>Enlace <em>Iniciar Trámite <img src="assets/img/FrontEnd/frontendf16.png" alt="" width="145" height="15" /> </em>: corresponde a la opción predeterminada que se abrirá al ingresar al portal, esta opción lista todos los trámites disponibles, tanto para trámites públicos, trámites sólo para usuarios registrados y trámites que hayan sido asignados directamente, para proceder a iniciar un nuevo trámite simplemente seleccione el botón <img src="assets/img/FrontEnd/frontendf2.png" alt="" width="55" height="17" /> , dentro de la fila del trámite que desea iniciar.</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf17.png" alt="" width="482" height="229" /></p>
<p style="text-align: center;">Figura 64: "FrontEnd Simple: Listado de Trámites disponibles a iniciar"</p>
<p> </p>
<p>Enlace <em>Bandeja de Entrada <img src="assets/img/FrontEnd/frontendf18.png" alt="" width="174" height="16" /></em> : con esta opción al usuario podrá revisar los trámites que se les ha sido asignado mediante un listado, por lo que podrá revisar y realizar, cada trámite asignado uno a uno.</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf19.png" alt="" width="547" height="162" /></p>
<p style="text-align: center;">Figura 65: "FrontEnd Simple: Bandeja de Entrada"</p>
<p> </p>
<p> </p>
<p>Para gestionar un trámite pendiente de realización, deberá hacer clic sobre el botón <em>Realizar</em>.</p>
<p> </p>
<p>Para eliminar un trámite desde la Bandeja de Entrada, es posible de realizar únicamente si en la gestión del trámite no existe participación de otros usuarios, esto lo podrá identificar porque bajo el trámite aparecerá el icono <img src="assets/img/FrontEnd/frontendf9.png" alt="" width="39" height="23" /> , en el que al realizar clic se podrá eliminar el trámite del sistema, considere que las eliminaciones no son reversibles.</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf21.png" alt="" width="606" height="217" /></p>
<p style="text-align: center;">Figura 66: "Eliminación de Trámites sin asignación desde la Bandeja de Entrada"</p>
<p> </p>
<p> </p>
<p>Enlace <em>Sin Asignar</em> <img src="assets/img/FrontEnd/frontendf22.png" alt="" width="146" height="17" />: con esta opción podrá revisar los trámites generados los cuales no tengan usuario ni grupo para su gestión (revisión), con esta opción usted podrá autoasignarse trámites para su gestión lo que hará que el trámite se mueva a su bandeja de entrada. Las opciones de la ventana Sin Asignar se visualizan en la imagen siguiente.</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf23.png" alt="" width="587" height="184" /></p>
<p style="text-align: center;">Figura 67: "FrontEnd Simple: Etapas Sin Asignar"</p>
<p> </p>
<p> </p>
<p>Para autoasignarse el trámite sin asignación, simplemente presione el botón <em>Asignármelo.</em> Al hacer esto el trámite irá inmediatamente a la bandeja de entrada de su usuario.</p>
<p> </p>
<p>Enlace <em>Participados  <img src="assets/img/FrontEnd/frontendf25.png" alt="" width="154" height="14" /></em>: con esta opción usted podrá ver el listado de todos los trámites que ha participado, en donde se le indicará su ID, el nombre del trámite que ha realizado, la etapa actual en que se encuentra el trámite, la última fecha que ha sido modificado dentro del proceso y el estado del trámite. Tal como se puede visualizar en la imagen siguiente.</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf26.png" alt="" width="608" height="181" /></p>
<p style="text-align: center;">Figura 68: "FrontEnd Simple: Listado de Trámites participados"</p>
<p> </p>
<p> </p>',
    'richtext' => 1,
    'template' => 1,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1353587295,
    'editedby' => 2,
    'editedon' => 1355257632,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1353587280,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Perfil Institucional</title>
    <!-- Bootstrap -->
...
<li class="last active current"><a href="simple/frontend/ingreso/perfil-institucional.html" title="Perfil Institucional" >Perfil Institucional</a></li>
</ul></li>
</ul></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/frontend/">Frontend</a> <span class="divider">/</span></li><li><a href="simple/frontend/ingreso/">Ingreso</a> <span class="divider">/</span></li><li>Perfil Institucional</li>
</ul>
				<h3>3.1.3      Perfil de Usuarios Institucionales: Participantes de la gestión y realización de un Trámite - Ventana Principal</h3>
<p> </p>
<p>Al ingresar un usuario registrado al portal y este además tiene privilegios especiales dado por el generador de Modelo de Procesos,  se desplegará una ventana con las operaciones disponibles similar que la ventana de trabajo para usuarios registrados, como se visualiza en la siguiente imagen:</p>
<p> </p>
<p style="text-align: center;"><img src="assets/img/FrontEnd/frontendf15.png" alt="" width="523" height="255" /></p>
