...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Configuración</title>
    <!-- Bootstrap -->
...
<li class="active current"><a href="simple/backend/configuracion/" title="Configuración" >Configuración</a><ul><li class="first"><a href="simple/backend/configuracion/inicial.html" title="Inicial" >Inicial</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li>Configuración</li>
</ul>
				<p>Cuando se habla de configuración en Simple se refiere a la gestión de usuarios y grupos de usuarios, tanto para generar nuevos o gestionar los existentes, esta configuración aplica únicamente para el proceso en el cual se está trabajando, no afecta otros procesos. Como se verá en este apartado.</p>
				</div>
			</div>
		</div>
