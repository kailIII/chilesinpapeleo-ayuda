<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>Antes de plasmar el diseño pensado para digitalizar el trámite en Simple, es necesario tener en cuenta los grupos y/o usuarios que participarán en las tareas del proceso, esto se debe, a que las tareas de un proceso deberán estar asociadas a grupos de usuarios o usuarios particulares. Como se explicará en las secciones posteriores del manual.</p>
<p>Para iniciar la configuración, debe dirigirse hacia el menú de <em>Configuración</em>, con esto ingresará al menú de <em>Accesos</em> de Simple.</p>
<p>La siguiente imagen se puede visualizar la pantalla de trabajo para la configuración sección <em>Accesos</em>:</p>
<p><img src="assets/img/BackEnd/Configuracion/Configuracion.png" alt="" width="879" height="500" /></p>
<p>las opciones disponibles son:</p>
<ul>
<li>Editar el nombre largo de la institución</li>
<li>Indicar un mesnaje de bienvenida</li>
<li>Cambiar el logo de la institución</li>
</ul>
<p>Como se puede visualizar en el recuadro izquierdo, se indica los accesos de usuarios del frontend a configurar, siendo también posible seleccionar los grupos de usuarios y ademas permite configurar los usuarios del backend.</p>
<p>Ademas existe la posibilidad de cambiar la contraseña del administrador como lo muestra la siguiente imagen:</p>
<p><img src="assets/img/BackEnd/Configuracion/cambiar_contraseña.png" alt="" width="856" height="281" /></p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 0,
    'searchable' => 1,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Inicial</title>
    <!-- Bootstrap -->
...
<li class="active"><a href="simple/backend/configuracion/" title="Configuración" >Configuración</a><ul><li class="first active current"><a href="simple/backend/configuracion/inicial.html" title="Inicial" >Inicial</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li><a href="simple/backend/configuracion/">Configuración</a> <span class="divider">/</span></li><li>Inicial</li>
</ul>
				<p>Antes de plasmar el diseño pensado para digitalizar el trámite en Simple, es necesario tener en cuenta los grupos y/o usuarios que participarán en las tareas del proceso, esto se debe, a que las tareas de un proceso deberán estar asociadas a grupos de usuarios o usuarios particulares. Como se explicará en las secciones posteriores del manual.</p>
<p>Para iniciar la configuración, debe dirigirse hacia el menú de <em>Configuración</em>, con esto ingresará al menú de <em>Accesos</em> de Simple.</p>
<p>La siguiente imagen se puede visualizar la pantalla de trabajo para la configuración sección <em>Accesos</em>:</p>
