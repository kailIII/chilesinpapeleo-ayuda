<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h3>1.1.1                 Generación de Documentos del proceso</h3>
<p>Simple tiene la capacidad de generar documentos para la entrega de información existiendo dos tipos: en blanco y certificados, este último con un formato preestablecido permitiendo ademas el uso de firma eletronica avanzada.</p>
<p><span style="text-decoration: underline;"><strong>Documento en blanco</strong></span></p>
<p>Es el tipo de documento más basico el cual posee un único campo de edición,  destacando entre sus cualidades el uso de variables y aplicar formato al documento con código HTML. Si su Modelo de Procesos requiere del diseño de documentos informales  es recomendable iniciar por esta etapa, ya que cada documento deberá ser asociado a un formulario posteriormente.</p>
<p>Para ingresar al menú de generación y gestión de documentos, deberá presionar sobre el botón Documentos, indicado en el recuadro en rojo siguiente:</p>
<p> </p>
<p><img style="line-height: 1.5em;" src="assets/img/BackEnd/Generacion-Documentos/MenúDocumentos.png" alt="" width="547" height="230" /></p>
<p><span style="line-height: 1.5em;">Figura 21: "Ventana de gestión de Documentos"</span></p>
<p> </p>
<p>El marco de trabajo para gestionar los documentos, permitirá realizar las opciones típicas de un mantenedor, siendo las siguientes:</p>
<ul>
<li>Botón <em>Nuevo </em>:
<ul>
<li>Permite generar un nuevo documento en Simple. Al presionar sobre el botón ingresará a la ventana para generar documentos dentro de Simple como se visualiza en la siguiente imagen:</li>
</ul>
</li>
</ul>
<p align="center"> </p>
<p><img src="assets/img/BackEnd/Generacion-Documentos/crear_documento.png" alt="" width="550" height="542" /></p>
<p>Figura 22: "Diseño de Nuevo Documento"</p>
<p> </p>
<p>En donde:</p>
<ul>
<li>Nombre: Corresponde al nombre del documento a generar.</li>
<li>Tipo de documento: Corresponde al tipo de documento a crear, existiendo en blanco y certificado.</li>
<li>Contenido: es el contenido que desea que desea tenga el documento, recordar que en esta sección podrá utilizar variables, como también formatear el documento codificando en HTML. En cuanto a la codificación en HTML va más allá del presente manual, por lo que se recomienda alguna guía práctica en internet.</li>
</ul>
<p> </p>
<p>Ya que el manual tiene como fin, ejemplificar la solicitud de cupones de pago para afiliados a CPA, la estructura del documento básico sería el siguiente:</p>
<p> </p>
<p><img src="assets/img/BackEnd/Generacion-Documentos/crear_documento2.png" alt="" width="524" height="541" /></p>
<p> Figura 23: "Edición de nuevo Documento para CPA"</p>
<p> </p>
<p> </p>
<ul>
<li>Botón <em>Editar </em>:
<ul>
<li>Permite modificar un reporte existente en Simple, abriendo el asistente de reportes de Simple, con esta opción podrá cambiar el nombre del reporte, añadir o quitar campos, del reporte seleccionado sobre el listado de reportes.</li>
</ul>
</li>
</ul>
<p> </p>
<p><img src="assets/img/BackEnd/Generacion-Documentos/editar_documento.png" alt="" width="646" height="186" /></p>
<p>Figura 24: "Ventana de Gestión de Documentos - Editar"</p>
<p> </p>
<p>Y posteriormente se desplegará el asistente de reporte, con la información original precargada:</p>
<p> </p>
<p><img src="assets/img/BackEnd/Generacion-Documentos/crear_documento2.png" alt="" width="524" height="541" /></p>
<p>Figura 25: "Ventana de Edición de Documento Existente"</p>
<p> </p>
<p>Una vez modificados los campos, simplemente presione el botón <em>Guardar</em> y el documento habrá quedado correctamente almacenado y disponibilizado para su uso en las tareas del modelo de procesos.</p>
<p> </p>
<ul>
<li>Botón <em>Eliminar </em>  :
<ul>
<li>Permite eliminar un documento existente en Simple, para esto haga clic sobre la fila con el documento a eliminar y pulse el botón Eliminar, luego tendrá que confirmar la acción, tenga precaución ya que esta operación no es reversible.</li>
</ul>
</li>
</ul>
<p> </p>
<p><img src="assets/img/BackEnd/Generacion-Documentos/editar_documento.png" alt="" width="646" height="186" /></p>
<p>Figura 26: "Ventana de Gestión de Documentos - Eliminar"</p>
<p> </p>
<ul>
<li>Botón <em>Previsualizar </em>:
<ul>
<li>Permite visualizar un Documento realizado en el sistema, esta funcionalidad es para revisar si el formato del documento y la estructura, está de acuerdo a lo que se espera.</li>
</ul>
</li>
</ul>
<p> </p>
<p><span style="text-decoration: underline;"><strong>Documento Certificado</strong></span></p>
<p>Corresponde a documentos con un formato pre-establecido para elaboración de certificados, ya sea con firma electrónica simple o avanzada. La creación, edición, previsualización y eliminación de este tipo de documentos se realiza de la misma manera que en los documentos en blanco a diferencia de los campos extras que a continuación se detallan: </p>
<ul>
<li>Nombre</li>
<li>Servicio que emite el documento</li>
<li>URL al sitio web del servicio</li>
<li>Logo del Servicio (Opcional)</li>
<li>Imagen del timbre (Opcional)</li>
<li>Nombre de la persona que firma (Opcional)</li>
<li>Cargo de la persona que firma (Opcional)</li>
<li>Servicio al que pertenece la persona que firma (Opcional)</li>
<li>Imagen de la firma</li>
<li>Numero de dias de validez (Dejar en blanco para periodo ilimitado)</li>
<li>Contenido</li>
</ul>
<p><img src="assets/img/BackEnd/Generacion-Documentos/crear_documento3.png" alt="" width="600" height="1113" /></p>
<p>Figura 27: "Diseño de Nuevo Documento tipo certificado"</p>
<p> </p>
<p> </p>',
    'richtext' => 1,
    'template' => 1,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1353507662,
    'editedby' => 2,
    'editedon' => 1369626604,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1353507660,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
	...
	<title>Ayuda ChileSinPapeleo - Generación de Documentos</title>
    <!-- Bootstrap -->
...
<li class="active"><a href="simple/backend/modelamiento-del-proceso/" title="Modelamiento del Proceso" >Modelamiento del Proceso</a><ul><li class="first active current"><a href="simple/backend/modelamiento-del-proceso/generacion-de-documentos.html" title="Generación de Documentos" >Generación de Documentos</a></li>
...
<li class="last"><a href="simple/video-tutoriales/parte-9-fin.html" title="Parte 9: Fin" >Parte 9: Fin</a></li>
				...
				<div class="span8">
				<ul class="breadcrumb">
  <li><a href="simple/">Simple</a> <span class="divider">/</span></li><li><a href="simple/backend/">Backend</a> <span class="divider">/</span></li><li><a href="simple/backend/modelamiento-del-proceso/">Modelamiento del Proceso</a> <span class="divider">/</span></li><li>Generación de Documentos</li>
</ul>
				<h3>1.1.1                 Generación de Documentos del proceso</h3>
<p>Simple tiene la capacidad de generar documentos para la entrega de información existiendo dos tipos: en blanco y certificados, este último con un formato preestablecido permitiendo ademas el uso de firma eletronica avanzada.</p>
<p><span style="text-decoration: underline;"><strong>Documento en blanco</strong></span></p>
<p>Es el tipo de documento más basico el cual posee un único campo de edición,  destacando entre sus cualidades el uso de variables y aplicar formato al documento con código HTML. Si su Modelo de Procesos requiere del diseño de documentos informales  es recomendable iniciar por esta etapa, ya que cada documento deberá ser asociado a un formulario posteriormente.</p>
<p>Para ingresar al menú de generación y gestión de documentos, deberá presionar sobre el botón Documentos, indicado en el recuadro en rojo siguiente:</p>
